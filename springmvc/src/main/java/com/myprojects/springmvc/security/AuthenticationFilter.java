...
import com.myprojects.springmvc.service.implementation.UserLoginRequestModel;
    ...
    public Authentication attemptAuthentication(HttpServletRequest req,
        ...
        try {
            UserLoginRequestModel creds = new ObjectMapper()
                    .readValue(req.getInputStream(), UserLoginRequestModel.class);                //this is how the json is converted in to java object
